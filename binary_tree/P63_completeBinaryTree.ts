 ...
 * left and right successors are 2*A and 2*A+1, respectively, supposed the successors
 * do exist. This fact can be used to elegantly construct a complete binary tree structure.
 ...
 */
export function completeBinaryTree(n: number): BinaryTree<string> {
  return null;
}
 ...
 */
export function isCompleteBinaryTree<T>(tree: BinaryTree<T>): boolean {
  return false;
}

/**
 * Get the height of a complete binary tree with N nodes
 */
export function getCompleteTreeHeight(n: number): number {
  return 0;
}

/**
 * Get the number of nodes in the last level of a complete binary tree
 */
export function getLastLevelNodes(n: number): number {
  return 0;
}

/**
 * Construct a complete binary tree using address-based approach
 */
export function completeBinaryTreeByAddress(n: number): BinaryTree<string> {
  return null;
}
